...
export const Faq = () => (
  <>
    <div className="faq-section pb-10" id="faq">
      <MiniBanner text1="Frequently Asked Questions" text2="Home" text3="FAQ" />
      <Container>
        <div className="row flex gap-4 mt-20 justify-content-center">
          <div className="w-[40%]">
            <div
            ...
            >
              ...
              <Link to="/job-list" className="eg-btn btn--primary5 btn--lg">
                Work Together
              </Link>
            </div>
          </div>
